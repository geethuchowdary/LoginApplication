    ...
    : QMainWindow(parent)
{
    ...
    l->move(100,50);
    QPixmap p("C:/Users/Admin/Desktop/images/login.png");
    l->setPixmap(p.scaled(20,20));

    QLabel *lb=new QLabel(this);
    lb->move(180,25);
    lb->setAlignment(Qt::AlignHCenter);
    QPixmap pi("C:/Users/Admin/Desktop/images/username.png");
    ...
    QPixmap pix("C:/Users/Admin/Desktop/images/password.png");
    ...
    connect(btn,&QPushButton::clicked,[=](){
        ...
        QString p=lie->text();
        if(uname=="Geethika"&& p=="212218104027")
        {
